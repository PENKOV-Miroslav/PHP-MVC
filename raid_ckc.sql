...
CREATE TABLE PARTICIPANT(
   ...
   CERTIFICAT_VALIDER_PARTICIPANT BOOLEAN NOT NULL,
   CLUB_PARTICIPANT VARCHAR(50)  NOT NULL,
   ID_RFID VARCHAR(50) ,
...
SELECT T.ID_PARTICIPANT, 
  MIN(CASE WHEN T.ID_EPREUVE = 1 THEN T.DUREE_TEMPS ELSE NULL END) AS "Course à pied", 
...
SELECT T.ID_PARTICIPANT, 
  MIN(CASE WHEN T.ID_EPREUVE = 4 THEN T.DUREE_TEMPS ELSE NULL END) AS "Course à pied", 
